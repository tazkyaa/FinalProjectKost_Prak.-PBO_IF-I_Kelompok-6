...
public class FasilitasPanel extends JPanel {
    ...
    private JPanel buildKondisiPage() {
        ...
        cmbKondisi = new JComboBox<>(new String[]{"baik", "rusak ringan", "rusak berat"});
            ...
            new javax.swing.table.DefaultTableCellRenderer() {
                @Override public Component getTableCellRendererComponent(JTable t, Object v,
                    ...
                    if (!sel) switch (s.toLowerCase()) {
                        case "baik":         setBackground(new Color(0x0B2A1E)); setForeground(AppTheme.SUCCESS); break;
                        case "rusak ringan": setBackground(new Color(0x2A1E0B)); setForeground(AppTheme.WARN);   break;
                        case "rusak berat":  setBackground(new Color(0x2A0B0B)); setForeground(AppTheme.DANGER); break;
